...
export function TxError({ error }: { error: string | null }) {
  ...
  return (
    <p className="mt-3 flex max-w-xl items-start gap-2 border border-rose-500/40 bg-rose-50 px-3.5 py-2.5 text-xs leading-relaxed text-rose-700">
...
export function TxSuccess({ message }: { message: string | null }) {
  ...
  return (
    <p className="mt-3 flex max-w-xl items-start gap-2 border border-emerald-500/40 bg-emerald-50 px-3.5 py-2.5 text-xs leading-relaxed text-emerald-700">
