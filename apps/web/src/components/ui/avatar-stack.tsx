...
const COIN_BG = [
  "color-mix(in srgb, var(--chart-1) 18%, hsl(var(--card)))",
  "color-mix(in srgb, var(--chart-5) 18%, hsl(var(--card)))",
  "color-mix(in srgb, var(--chart-2) 18%, hsl(var(--card)))",
  "color-mix(in srgb, var(--chart-3) 18%, hsl(var(--card)))",
]
 ...
 */
export function AvatarStack({ names, images = [], max = 4, className }: AvatarStackProps) {
  const reduced = useReducedMotion()
